...
public class BigSum {
    ...
    public static String sum(int nums[]) {
        List<String> collect = Arrays.stream(nums).mapToObj(Integer::toString).sorted((a, b) -> b.length() - a.length()).collect(Collectors.toList());
        int longestNumber = collect.get(0).length();

        collect = collect.stream().map(a -> insertLeadingZeros(a, longestNumber)).collect(Collectors.toList());
    ...
    public static void main(String[] args) {
        int nums[] = {1001458909, 1004570889, 1007019111, 1003302837, 1002514638, 1006431461, 1002575010, 1007514041, 1007548981, 1004402249, 5};
